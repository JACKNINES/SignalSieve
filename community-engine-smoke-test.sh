...
swiftc \
    ...
    -L "$BUILD_DIR" \
    -lSignalSieveCore \
    "$PROJECT_ROOT/Tests/CommunityEngineIntegrationRunner/main.swift" \
    -o "$BUILD_DIR/SignalSieveCommunityEngineIntegration" \
    -Xlinker -rpath \
    -Xlinker @executable_path

"$BUILD_DIR/SignalSieveCommunityEngineIntegration"
