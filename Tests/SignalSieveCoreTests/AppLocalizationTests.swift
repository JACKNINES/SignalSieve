...
func translatesPrimaryInterfaceText() {
    ...
    let popupKeys = [
        ...
        "Edit the text to inspect. Signal Sieve analyzes it locally.",
        "Clean or analyze Input to prepare a reviewable Result.",
        "Review generated output before copying or using it.",
        "Paste clipboard text into Input. Shortcut: Command-Option-V.",
        "Inspect Input locally. Shortcut: Command-Return.",
        "Prepare a Safe Clean result. Shortcut: Command-K.",
        "Prepare a Strict Clean result. Shortcut: Command-Shift-K.",
        "Clean tracked links locally. Shortcut: Command-Option-L.",
        "Move Result back to Input. Shortcut: Command-Shift-Return.",
        "Copy Result to the clipboard. Shortcut: Command-Shift-C.",
        ...
        "Clean Receipt: no supported cleaning risks remain",
        "Clean Receipt: cleaned, but review the source",
        "Clean Receipt: risk remains — do not share",
        "Automatic cleaning result quarantined",
        "Technical evidence",
        "Protocol: %@",
        "Original alerts: %d · highest severity: %@",
        "Deterministic changes: %d removed · %d replaced",
        "Remaining alerts: %d · highest severity: %@",
        "Automatic cleaning skipped: yes",
        "Automatic cleaning skipped: no",
        "standard",
        "elevated",
        "Copy Clean Result",
        "Restore Original",
        "Copies the cleaned text only if the clipboard still matches this receipt.",
        "Copies the cleaned text only if the clipboard still matches this history item.",
        "Restores the original text only if the clipboard still holds the clean result.",
        "No clean result is available for this copy.",
        "The clipboard changed after the receipt, so SignalSieve did not copy the clean result.",
        "Copied the clean result from this receipt.",
        "Copied the clean result from session history.",
        "The clean result is already on the clipboard.",
        "The original is not restorable for this copy.",
        "The clipboard changed after the receipt, so SignalSieve did not restore the original.",
        "Restored the original text from session memory.",
        "Restored the original text from session history.",
        "Clean Receipt quarantined this copy. A high-risk finding remained after reanalysis, so SignalSieve did not overwrite the clipboard.",
        "Automatic cleaning skipped: source code.",
        "Automatic cleaning skipped: file or image representation.",
        "Automatic cleaning skipped: privacy-sensitive clipboard type.",
        "Automatic cleaning skipped: input too large.",
        "Automatic cleaning skipped: OCR integrity check failed.",
        "Automatic cleaning skipped: local OCR failed.",
        "Automatic Visual Transfer skipped replacement because its integrity check failed.",
        "Automatic Visual Transfer skipped replacement because local OCR failed.",
        "High-risk finding remained after reanalysis.",
        "High-risk finding was removed; review the source.",
        "Lower-risk findings remain after reanalysis.",
        "No supported cleaning risks were detected.",
        "No supported cleaning risks remain after reanalysis.",
